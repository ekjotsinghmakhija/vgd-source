...
<div class="min-h-screen bg-vgd-dark-gray text-white">
  ...
  <div class="max-w-7xl mx-auto px-4 lg:px-8 py-6 space-y-6">
    <div class="flex items-center justify-between gap-4 flex-wrap">
      <div>
        <h1
          class="text-2xl font-mono tracking-[0.2em] uppercase text-vgd-yellow"
        >
          Downloads
        </h1>
        <p class="text-sm text-vgd-light-gray">
    ...
    {#if !hasDownloads}
      <div
        class="rounded border border-vgd-medium-gray/30 bg-vgd-black/30 p-6 text-center text-vgd-light-gray space-y-2"
      >
        <div class="text-sm">
    ...
    {:else}
      <div class="downloads-grid gap-4">
        {#each downloadOverview as node}
          <div
            class="rounded border border-vgd-medium-gray/30 bg-vgd-black/30 p-4 space-y-3 flex flex-col"
          >
            <div class="flex items-center justify-between gap-3">
              <div class="min-w-0 flex-1">
                ...
                <div class="text-xs text-vgd-light-gray font-mono truncate">
                  {node.nodeId}
                </div>
              </div>
              <div
            ...
            {#each node.models as model}
              ...
              <div
                class="rounded border border-vgd-medium-gray/30 bg-vgd-dark-gray/60 p-3 space-y-2"
              >
                <div class="flex items-center justify-between gap-3">
                ...
                <div
                  class="relative h-2 bg-vgd-black/60 rounded-sm overflow-hidden"
                >
                  <div
                ...
                <div
                  class="flex items-center justify-between text-xs font-mono text-vgd-light-gray"
                >
                  <span
                ...
                {#if isExpanded}
                  <div class="mt-2 space-y-1.5">
                    {#if model.files.length === 0}
                      <div class="text-[11px] font-mono text-vgd-light-gray/70">
                    ...
                    {:else}
                      {#each model.files as f}
                        ...
                        <div
                          class="rounded border border-vgd-medium-gray/20 bg-vgd-black/40 p-2 space-y-1"
                        >
                          <div
                            class="flex items-center justify-between text-[11px] font-mono text-vgd-light-gray/90"
                          >
                            ...
                            <span
                              class={fpct >= 100
                                ...
                                : fpct <= 0
                                  ? "text-red-400"
                                  : "text-vgd-yellow"}>{fpct.toFixed(1)}%</span
                            >
                          </div>
                          <div
                          ...
                          <div
                            class="flex items-center justify-between text-[10px] text-vgd-light-gray/70"
                          >
                            <span
