...
from vgd.master.image_store import ImageStore
from vgd.master.placement import place_instance as get_instance_placements
from vgd.shared.apply import apply
from vgd.shared.constants import VGD_IMAGE_CACHE_DIR, VGD_MAX_CHUNK_SIZE
from vgd.shared.election import ElectionMessage
from vgd.shared.logging import InterceptLogger
from vgd.shared.models.model_cards import (
    MODEL_CARDS,
    ModelCard,
    ModelId,
)
...
from vgd.shared.types.chunks import (
    ErrorChunk,
    ImageChunk,
    InputImageChunk,
    TokenChunk,
...
from vgd.shared.types.commands import (
    ChatCompletion,
    Command,
    CreateInstance,
    DeleteInstance,
...
from vgd.shared.types.common import CommandId, Id, NodeId, SessionId
...
from vgd.utils.banner import print_startup_banner
from vgd.utils.channels import Receiver, Sender, channel
from vgd.utils.dashboard_path import find_dashboard
...
class API:
    def __init__(
        ...
        *,
        ...
        self._image_store = ImageStore(VGD_IMAGE_CACHE_DIR)
    ...
    async def _send_image_edits_command(
        ...
        data_chunks = [
            image_data[i : i + VGD_MAX_CHUNK_SIZE]
            for i in range(0, len(image_data), VGD_MAX_CHUNK_SIZE)
        ]
