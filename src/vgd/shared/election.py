...
from vgd.routing.connection_message import ConnectionMessage
from vgd.shared.types.commands import ForwarderCommand
from vgd.shared.types.common import NodeId, SessionId
from vgd.utils.channels import Receiver, Sender
        ...
        with self._em_receiver as election_messages:
            async for message in election_messages:
                ...
                if message.proposed_session.master_node_id == self.node_id:
                    ...
                    # Drop messages from us (See vgd.routing.router)
                    continue
