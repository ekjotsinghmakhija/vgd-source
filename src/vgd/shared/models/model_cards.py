...
MODEL_CARDS: dict[str, ModelCard] = {
    ...
    # Image models commented out - feature not stable (see https://github.com/vgd-explore/vgd/issues/1242)
...
async def get_safetensors_size(model_id: ModelId) -> Memory:
    ...
    from vgd.shared.types.worker.downloads import ModelSafetensorsIndex
    from vgd.worker.download.download_utils import (
        download_file_with_retry,
        ensure_models_dir,
    )
