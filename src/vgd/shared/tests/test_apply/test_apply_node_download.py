from vgd.shared.apply import apply_node_download_progress
from vgd.shared.tests.conftest import get_pipeline_shard_metadata
from vgd.shared.types.common import NodeId
from vgd.shared.types.events import NodeDownloadProgress
from vgd.shared.types.memory import Memory
from vgd.shared.types.state import State
from vgd.shared.types.worker.downloads import DownloadCompleted
from vgd.worker.tests.constants import MODEL_A_ID, MODEL_B_ID
