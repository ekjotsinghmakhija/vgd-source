...
from vgd.shared.election import Election, ElectionMessage, ElectionResult
from vgd.shared.types.commands import ForwarderCommand, TestCommand
...
def fast_election_timeout(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr("vgd.shared.election.DEFAULT_ELECTION_TIMEOUT", 0.1)
