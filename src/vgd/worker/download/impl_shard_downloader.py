...
from vgd.worker.download.download_utils import RepoDownloadProgress, download_shard
from vgd.worker.download.shard_downloader import ShardDownloader


def vgd_shard_downloader(max_parallel_downloads: int = 8) -> ShardDownloader:
