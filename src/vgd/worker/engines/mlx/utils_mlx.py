...
from vgd.worker.engines.mlx.constants import (
    CACHE_GROUP_SIZE,
    KV_CACHE_BITS,
    TRUST_REMOTE_CODE,
)
...
from vgd.shared.types.common import Host
...
from vgd.worker.engines.mlx.auto_parallel import (
    TimeoutCallback,
    eval_with_timeout,
...
# TODO: Test this
#  ALSO https://github.com/vgd-explore/vgd/pull/233#discussion_r2549683673
...
def shard_and_load(
    ...
    base_timeout = float(os.environ.get("VGD_MODEL_LOAD_TIMEOUT", "60"))
